...
const progress = savedProgress ? JSON.parse(savedProgress) : {}
  ...
  const completedCount = Object.values(roadmapProgress)
    .filter(Boolean)
    .length
  ...
  const percent = totalTopics
    ...
    : 0
                ...
                return (
                <div key={roadmap.id} onClick={()=> navigate(`/roadmap/${roadmap.id}`)} className="bg-slate-900 border border-slate-800 p-6 rounded-xl cursor-pointer hover:border-indigo-500">
